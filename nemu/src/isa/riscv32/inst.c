...
// R type
  ...
  INSTPAT("0100000 ????? ????? 000 ????? 01100 11", sub    , R, R(rd) = src1 - src2);   //加减有无负号都同，无需转换
  ...
  // M扩展
  INSTPAT("0000001 ????? ????? 000 ????? 01100 11", mul    , R, R(rd) = (((uint64_t)src1 * (uint64_t)src2) & 0xFFFFFFFF));
  ...
  INSTPAT("0000001 ????? ????? 100 ????? 01100 11", div    , R, R(rd) = (src2 != 0) ? (src1 == (2^31) && src2 == ((2^32) - 1)) ? (sword_t)(-2^31) : ((sword_t)src1 / (sword_t)src2) : (sword_t)(-1));
  INSTPAT("0000001 ????? ????? 101 ????? 01100 11", divu   , R, R(rd) = (src2 != 0) ? (src1 / src2) : (word_t)((2^32) - 1));
  INSTPAT("0000001 ????? ????? 110 ????? 01100 11", rem    , R, R(rd) = (src2 != 0) ? (src1 == (2^31) && src2 == ((2^32) - 1)) ? (sword_t)(0) : ((sword_t)src1 % (sword_t)src2) : (sword_t)(src1));
  INSTPAT("0000001 ????? ????? 111 ????? 01100 11", remu   , R, R(rd) = (src2 != 0) ? (src1 % src2) : (src1));
// I type
  INSTPAT("??????? ????? ????? 000 ????? 00100 11", addi   , I, R(rd) = src1 + imm);    //imm有符号，addi可减
  ...
  INSTPAT("0000000 ????? ????? 001 ????? 00100 11", slli   , I, R(rd) = src1 << (imm & 0x1F));  //取imm低5位
